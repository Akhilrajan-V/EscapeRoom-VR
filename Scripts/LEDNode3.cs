...
public class LEDNode3 : MonoBehaviour
{
    // Previous linked LED node.
    public LEDNode3 prevNode = null;
    ...
    [SerializeField] CrossbowBuild _crossbowCntrl;
    ...
    private void ResolveNodeState3()
    {
        switch (lightState)
        {
